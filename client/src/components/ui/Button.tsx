...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-emerald-600 hover:bg-emerald-500 text-white focus:ring-emerald-500 shadow-lg shadow-emerald-950/40',
    secondary: 'bg-slate-800 hover:bg-slate-700 text-slate-100 focus:ring-slate-600 border border-slate-700',
    outline: 'border border-slate-700 hover:border-emerald-500/50 hover:bg-slate-900/50 text-slate-300 hover:text-emerald-400 focus:ring-emerald-500',
